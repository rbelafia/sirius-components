...
public final class UpdateNodeBoundsInput implements IDiagramInput {
    ...
    public String toString() {
        String pattern = "{0} '{'projectId: {1}, representationId: {2}, diagramElementId: {3}, newPositionX: {4}, newPositionY: {5}, newWidth: {6}, newHeight: {7}'}'"; //$NON-NLS-1$
        return MessageFormat.format(pattern, this.getClass().getSimpleName(), this.projectId, this.representationId, this.diagramElementId, this.newPositionX, this.newPositionY, this.newWidth,
                this.newHeight);
    }
}
