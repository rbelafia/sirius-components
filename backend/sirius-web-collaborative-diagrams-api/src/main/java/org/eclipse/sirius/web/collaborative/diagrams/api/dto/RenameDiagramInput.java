...
public final class RenameDiagramInput implements IDiagramInput {
    ...
    public RenameDiagramInput(UUID projectId, UUID diagramId, String newLabel) {
    ...
    public String toString() {
        ...
        return MessageFormat.format(pattern, this.getClass().getSimpleName(), this.diagramId, this.newLabel);
    }
}
